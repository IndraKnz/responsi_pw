...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DCwmDICI.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-JcdXfCG6.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-vk_nO2f_.js").then((r) => r.default || r));
